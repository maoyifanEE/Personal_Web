...
if (typeof window === 'object') {
	window.__paperFullStarted = true;
}
...
// Personal_Web local browser bridge: expose the official Paper.js build to journey.js.
if (typeof window === 'object' && typeof paper !== 'undefined') {
	window.paper = paper;
}
